  ...
  \chapter{Optimisation à objectifs multiples}
    ...
    \section{Influence du paramétrage}
      ...
      \begin{figure}[h]
        ...
        \caption{Représentation de la solution au cours des générations - Variation de la taille de la population sur [10,400] avec un pas de 10 - Autre paramètres : $P_mutation = 0.5$,$P_{crossover} = 0.5$}
