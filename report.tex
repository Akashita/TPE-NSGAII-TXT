...
[DTLZ]
      ...
      Enfin, la variation de la probabilité de mutation nous donne la figure \ref{sch_mutation_moy}. On remarque que contrairement à toutes les figure précédentes, l'augmentation de la probabilté de mutation n'améliore pas la convergence vers la solution de référence, mais que au contraire elle la dégrade. Et d'ailleur, si on reprend la définition de la mutation dans les cadre des algorithmes génétiques cela paraît logique. La mutation n'est pas là pour améliorer la vitesse de convergence, mais plutôt pour éviter à l'algorithme de tomber dans un extremum local.
