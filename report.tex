  ...
  \chapter{Optimisation à objectif unique}
    ...
    \section{Influence du paramétrage }
      ...
      \subsection{Taille de la population}
        ...
        \end{figure}
        %Le premier graphique représente les données des fichiers,sans lissage. Bien que plus réaliste, celle ci ne permet pas ... La figure suivante, après lissage est alors plus utile et pratique
